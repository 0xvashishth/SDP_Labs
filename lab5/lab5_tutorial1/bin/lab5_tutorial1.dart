...
void main(List<String> arguments) {
  ...
  print(bakry.containsKey('pies'));
  print(bakry.containsValue(42));

  for (var item in bakry.keys) {
    print(bakry[item]);
  }

  bakry.forEach((key, value) => print("$key: $value"));

  for (var itr in bakry.entries) {
